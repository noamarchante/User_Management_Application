...
public class CUser {
    ...
    @PostMapping("/userAdd")
    public ResponseEntity<Void> addUser(@RequestHeader("Accept=application/json") @RequestBody @Valid MUser mUser, UriComponentsBuilder builder){
    ...
    public ResponseEntity<MUser> updateUser(@RequestHeader("Accept=application/json") @RequestBody @Valid MUser mUser) {
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable("userId") String userId) {
        boolean flag = sUser.deleteUser(userId);
        if (!flag){
    ...
    public ResponseEntity<MUser> getUserById(@PathVariable("userId") String userId) {
        MUser mUser = sUser.selectUserByUserId(userId);
        return new ResponseEntity<>(mUser, HttpStatus.OK);
    }

    @GetMapping("/userSelect")
    public ResponseEntity<List<MUser>> getAllUser(){
        List<MUser> userList = sUser.selectAllUser();
        return new ResponseEntity<>(userList, HttpStatus.OK);
    }

    @GetMapping("/userPageableSelect")
    public ResponseEntity<List<MUser>> getPageableUser(Pageable pageable){
        List<MUser> userList = sUser.selectPageableUser(pageable);
        return new ResponseEntity<>(userList, HttpStatus.OK);
    }

    @GetMapping("/userUserGroupUserSelect/{userId}")
    public ResponseEntity<List<MUserGroupUser>> getUserGroupUserByUserId(@PathVariable("userId") String userId){
        List<MUserGroupUser> userGroupUserList = sUser.selectUserGroupUserbyUserId(userId);
